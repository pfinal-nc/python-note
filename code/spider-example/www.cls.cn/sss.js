...
// -1678344439, -179570816, 1652989885, -1056818, -1032039031          091f85dd6463852f8445039d60b4633d
//   console.log(rawDigest("app=CailianpressWeb&os=web&sv=7.5.5"))
//   console.log(rawDigest("app=CailianpressWeb&os=web&sv=7.5.5").buffer)
//   console.log(i(rawDigest("app=CailianpressWeb&id=1000&last_time=&os=web&rn=20&sv=7.7.5").buffer))
//    'app=CailianpressWeb&id=1000&last_time=1634531470&os=web&rn=20&sv=7.5.5'          'c4d2232295a178191a11b232d4ba2faf3e3b16db'

function get_sign(strs) {
    strs1 = i(rawDigest(strs).buffer)
    console.log(strs1)
    sign = get_sign2(strs1)

    return sign
}


console.log(get_sign("app=CailianpressWeb&id=1000&last_time=&os=web&rn=20&sv=7.7.5"))
// # bf0f367462d8cd70917ba5eab3853bce
