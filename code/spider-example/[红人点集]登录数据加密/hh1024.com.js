...
function getEncryptionSig(e) {
    return getEncryption(P(S(e)))
}


let t = new Date().getTime();
let pwd = getEncryption('123123');
let params = {
    "phoneNum": "111111111112222",
    "pwd": pwd,
    "t": t,
    "tenant": 1
}

console.log(getEncryption('123123'))
console.log(getEncryptionSig(params))