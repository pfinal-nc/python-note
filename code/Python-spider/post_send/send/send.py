...
proxy = {
    'http': 'http://117.191.11.102:80',
    'http': 'http://222.223.182.66:8000',
}

url = 'http://www.whrhkj.com/land/ajax_eroll'
body = {"name": "王小小", "mobile": "17721213680", "wx_kc": "268特惠《会计速成班", 'type': 24}
headers = {
    'Host': 'www.whrhkj.com',
    'Connection': 'keep-alive',
    'Content-Length': '141',
    'Cache-Control': 'max-age=0',
    'Origin': 'http://www.whrhkj.com',
    'Upgrade-Insecure-Requests': '1',
    'Content-Type': 'application/x-www-form-urlencoded',
    'User-Agent': UserAgent().random,
    'Accept': 'application/json, text/javascript, */*; q=0.01',
    'Referer': 'http://www.whrhkj.com/course',
...
def send_message():
    body['name'] = create_name()
    body['mobile'] = create_phone()
    # print(body)
...
def send_code(mobile):
    headers_end = {
        ...
        'Content-Length': '141',
        'Cache-Control': 'max-age=0',
        'Origin': 'http://wap.whrhkj.com',
        'Upgrade-Insecure-Requests': '1',
        'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
        'User-Agent': UserAgent().random,
        'Accept': '*/*',
        'Referer': 'http://wap.whrhkj.com/form/shiting?shicaobanner',
        'Accept-Encoding': 'gzip, deflate, br',
        'Accept-Language': 'zh-CN,zh;q=0.9,en;q=0.8',
        'X-Requested-With': 'XMLHttpRequest',
    }
    mess = {'mobile': mobile}
    data = urllib.parse.urlencode(mess).encode('utf-8')
    # r = requests.post(url, data=data, proxies=proxy, headers=headers)
    code_url = 'http://wap.whrhkj.com/index.php/Enroll/send_code.html'

    r = requests.post(code_url, data=str(data), proxies=proxy, headers=headers_end)
    print(r)
