# -*- coding: utf-8 -*-
# @Time    : 2023/5/10 13:32
# @Author  : PFinal南丞 <lampxiezi@163.com
# @File    : handle_autohome_app_koubei.py
# @Software: PyCharm
import re
...
class AutohomeKoubei(object):
    ...
    def __init__(self):
        ...
        self.font_list = [" ", "中", "低", "是", "级", "排", "坐", "硬", "量", "五", "下", "里", "软", "矮", "八", "档", "灯", "空", "过", "光", "大", "手", "公", "开", "地", "保", "左", "机", "远",
                          "音", "性", "身", "不", "三", "长", "冷", "的", "泥", "皮", "二", "当", "右", "了", "门", "高", "和", "有", "油", "味", "呢", "七", "少", "小", "孩", "坏", "", "电", "多",
                          "养", "动", "六", "来", "加", "控", "只", "副", "响", "耗", "短", "自", "内", "十", "外", "得", "真", "无", "上", "比", "启", "盘", "一", "好", "雨", "路", "实", "九", "问",
                          "近", "着", "更", "四", "很"]
