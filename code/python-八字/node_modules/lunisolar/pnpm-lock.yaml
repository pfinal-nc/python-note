...
devDependencies:
  ...
  '@rollup/plugin-terser': 0.2.1_rollup@2.79.1
  '@types/jest': 27.5.2
  '@types/node': 17.0.45
  ...
  rollup-plugin-clear: 2.0.7
  rollup-plugin-copy: 3.4.0
  rollup-plugin-dts: 4.2.3_ntuob3xud5wukob6phfmz2mbyy
  rollup-plugin-filesize: 10.0.0
  rollup-plugin-typescript2: 0.31.2_ntuob3xud5wukob6phfmz2mbyy
  ts-jest: 29.0.4_phwmm3fsgrpxk4tfw5el5jsy3a
...
packages:
  ...
  /ts-jest/29.0.4_phwmm3fsgrpxk4tfw5el5jsy3a:
    resolution: {integrity: sha512-YdNofkoyzeinwjIqLSYQeAM+GTmFQ7xFNtWcR5OyitY5VLzzNINrNmfhP5H3daA/V+RGQR7O3g1K6ysRgu5xIQ==}
    engines: {node: ^14.15.0 || ^16.10.0 || >=18.0.0}
    hasBin: true
    peerDependencies:
